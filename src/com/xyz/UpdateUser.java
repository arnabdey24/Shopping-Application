...
public class UpdateUser {
    ...
    public UpdateUser(Stage window, double height, double weight,Connection con,Session session,int field,Customer customer,Employee employee) {
        this.height = height;
        this.weight = weight;
        this.window = window;
        this.con=con;
        ...
        String s=field==0?"Update Customer":"Update Employee";
        ...
        TextField firstName=new TextField(field==0?customer.getFirstName():employee.getFirstName());
        firstName.setMaxWidth(200);
        firstName.setPromptText("First Name");
        firstName.setFocusTraversable(false);
        GridPane.setConstraints(firstName,0,0);
        TextField lastName=new TextField(field==0?customer.getLastName():employee.getLastName());
        lastName.setMaxWidth(200);
        lastName.setPromptText("Last Name");
        lastName.setFocusTraversable(false);
        GridPane.setConstraints(lastName,1,0);
        TextField userName=new TextField(field==0?customer.getUserName():employee.getUserName());
        userName.setMaxWidth(200);
        userName.setPromptText("Username");
        userName.setFocusTraversable(false);
        GridPane.setConstraints(userName,0,1);
        TextField password=new TextField(field==0?customer.getPassword():employee.getPassword());
        password.setMaxWidth(200);
        password.setPromptText("Password");
        password.setFocusTraversable(false);
        GridPane.setConstraints(password,1,1);
        TextField email=new TextField(field==0?customer.getEmail():employee.getEmail());
        ...
        BlackBtn addBtn = new BlackBtn("Update", 200, 80, Color.BLACK);
        ...
        addBtn.setOnMouseClicked(event -> {
            ...
            if(_first.isEmpty() && _last.isEmpty() &&
                ...
                try {
                    UpdateUser(_email,_first,_last,_uName,_password,_address,field);
    ...
    void UpdateUser(String email,String first,String last, String uname,String password,String address,int isEmp) throws SQLException {
