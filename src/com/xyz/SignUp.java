...
public class SignUp {
    ...
    public SignUp(Stage window, double height, double weight,Connection con,Session session) {
        this.height = height;
        this.weight = weight;
        this.window = window;
        this.con=con;
        ...
        signUp.setOnMouseClicked(event -> {
            ...
            if(_first.isEmpty() && _last.isEmpty() &&
                ...
                try {
                    createUser(_email,_first,_last,_uName,_password,_address,0);
                    session.uid=_email;
                    session.isImp=0;
        ...
        center.getChildren().addAll(firstName,lastName,userName,email,password,address,signUp,backBtn);
